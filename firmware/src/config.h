...
#ifndef V1401
//  #define CONFIG_X_STEPS_PER_MM 44.44444444 //microsteps/mm (no integers, e.g. use 80.0 instead of 80)
  #define CONFIG_X_STEPS_PER_MM 79.99999999 //microsteps/mm (no integers, e.g. use 80.0 instead of 80)
//  #define CONFIG_Y_STEPS_PER_MM 44.44444444 //microsteps/mm (no integers, e.g. use 80.0 instead of 80)
